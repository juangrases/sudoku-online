...
//    ),
    Array(
      Array(None, None, None, None, None, None, None, Some(8), Some(7)),
      Array(None, Some(5), Some(7), Some(3), None, None, None, None, None),
      Array(None, None, Some(4), Some(5), None, None, Some(2), Some(6), None),
      Array(None, Some(8), None, None, None, None, None, None, Some(4)),
      Array(Some(9), None, Some(6), None, Some(7), None, None, None, None),
      Array(None, None, Some(3), None, None, Some(5), Some(8), None, None),
      Array(None, None, None, Some(7), None, Some(6), None, Some(3), None),
      Array(None, Some(1), None, None, None, None, None, None, Some(2)),
      Array(None, Some(3), None, Some(9), None, None, None, Some(7), Some(5))
    )
  )
